...
public class Projeto {
    ...
    public boolean equals(Object o) {
        // Compra se estão no mesmo local da memória
        if (this == o) return true;
        // Se "o" é nulo OU se a classe dos dois for diferente, então são diferentes
        if (o == null || getClass() != o.getClass()) return false;
        Projeto projeto = (Projeto) o; // Tenta converter o objeto genérico para Projeto.
        // Se o ID dos ojetos forem iguais, então os objetos são iguais.
